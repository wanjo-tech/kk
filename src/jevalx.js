...
let WhiteListGlobal = ['Object','Array','Promise','Function','eval','Date','Number','String','Set'];for (let v of Object.getOwnPropertyNames(this)){if(!(WhiteListGlobal.indexOf(v)>=0)){delete this[v]}}
